...
objective: >-
  ...
  ground truth.
approach: >-
  Search for HodgeRank papers (Jiang et al., Mathematical Programming 2011) and graph decomposition theory to understand sparse
  linear algebra formulation and implementation patterns. Fetch the CIDRE paper (Sinatra & Rosvall, Scientific Reports 2021)
  to understand how dcSBM excess citation fractions are computed and what parameters control it. Search for papers on reciprocal
  citation detection and prior cartel thresholds. Locate and document Clarivate's suppressed journals list (expect 46+ confirmed
  pairs/groups) and understand its format and reliability.
depends_on: []
</artifact_direction>
...
### [3] SKILL-INPUT — aii-web-tools · 2026-07-09 00:26:58 UTC
